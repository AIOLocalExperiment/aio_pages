...
INPUT_CSV = "full_samples/retrievals_retry.csv"
OUTPUT_CSV = "full_samples/retrievals_formatted_retry.csv"
...
- Treat summary phrases with a colon as headings. 
- Do NOT ever bold a full sentence.
- Do NOT bold full list items. For example, a sentence like "Use apps like Google Maps and set your route to see toll costs if available." should NOT be bold
- Only assign headings to existing standalone phrases followed by lists (e.g. "Who is eligible for a free card?", 
